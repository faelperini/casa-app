...
type Props = {
  group: { id: string; name: string; shoppingItems: Item[] };
};

export function ShoppingPageClient({ group: initial }: Props) {
  const router = useRouter();
  const [items, setItems] = useState(initial.shoppingItems);
